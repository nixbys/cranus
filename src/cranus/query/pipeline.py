...
from cranus.retrieval.embeddings import embed_query
from cranus.retrieval.fusion import FusedResult, rrf_merge
...
def _graph_lookup(question: str) -> list[FusedResult]:
    ...
    try:
        from cranus.graph.query_support import graph_lookup_for_question
