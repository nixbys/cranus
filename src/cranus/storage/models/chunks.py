...
`cranus_to_tsvector` immutable wrapper function it depends on) so lexical
...
from cranus.storage.models.base import Base, TimestampMixin, new_id
...
class Chunk(Base, TimestampMixin):
    ...
    tsv: Mapped[str] = mapped_column(
        TSVECTOR, Computed("cranus_to_tsvector(text)", persisted=True), nullable=True
    )
