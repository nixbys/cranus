...
from cranus.api.deps import require_role
from cranus.storage.models.governance import ROLE_ADMIN, User
...
def export_audit_events(_user: User = Depends(_admin_only)) -> dict:
    from cranus.storage.iceberg_export import export_audit_events as run_export
